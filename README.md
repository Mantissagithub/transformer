...
| Group | Choices |
|-------|---------|
| Attention | mha, gqa, gqa_rope, mqa, sliding_window, sliding_gqa, gemma3_hybrid, csa, hca, mla, msa, kda. See [`docs/attention.md`](docs/attention.md) for the variant notes and diagrams. |
